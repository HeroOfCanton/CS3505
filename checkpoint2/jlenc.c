                            ...
                            const AVFrame *pict, int *got_packet)
{
    ...
    int n_bytes_image, n_bytes_per_row, n_bytes, i, ret, hsize;
    ...
    // and related pages.
#define SIZE_MPFFFILEHEADER 4
#define SIZE_MPFFINFOHEADER 8
    ...
    bytestream_put_byte(&buf, 'F');                   // BITMAPFILEHEADER.bfType
